 ...
 * 该文件中的目录主要用法
 *
 * node generator_bundle_reslit.js -p projectPath -b bundleName 生成bundle对应的reslist.ts文件
 * node generator_bundle_reslit.js -p projectPath -a            生成所有的bundlelist.ts文件
 * 
